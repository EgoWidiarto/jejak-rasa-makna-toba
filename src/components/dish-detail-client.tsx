    ...
    <main className="min-h-screen bg-[#F4F4F4] py-8 sm:py-12 lg:py-16">
      ...
      <RevealSection as="div" className="mx-auto pt-6 w-full pb-12 max-w-7xl px-4 sm:px-6 lg:px-8 mt-6" delay={0.12}>
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold leading-tight text-[#B02627] sm:text-4xl [font-family:var(--font-roboto)]">
            {type === "traditional" ? t("upacaraAdatSub") : t("harianSub")}
          </h2>
          <p className="mx-auto mt-3 max-w-2xl text-lg [font-family:var(--font-roboto)] text-[#B02627] sm:text-2xl">
            {t("kenaliLebihDalam")}
          </p>
        </div>

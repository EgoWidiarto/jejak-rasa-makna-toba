        ...
        <div className="relative w-full h-80 sm:h-100 lg:h-125 overflow-hidden rounded-3xl">
          ...
          <div className="absolute inset-0 flex items-end">
            <div className="w-full px-6 pb-10 sm:px-8 sm:pb-14 lg:px-10 lg:pb-18">
              <p className="mb-1 text-lg font-black text-white sm:text-xl lg:text-2xl [font-family:var(--font-roboto)]">Menjelajahi Warisan Budaya</p>
              <span className="text-3xl italic text-white sm:text-4xl lg:text-5xl font-['Atziluth']">Kuliner Batak Toba</span>
            </div>
          </div>

          {/* PERBAIKAN 3: Menyesuaikan posisi titik navigasi */}
